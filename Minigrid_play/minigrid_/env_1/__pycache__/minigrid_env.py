...
class MiniGridEnv(gym.Env):
    ...
    def __init__(
        ...
        # Trigger activation switch
        self.trigger_switch= False

        # Goal activation switch
    ...
    def goal_found(self) -> bool:
        ...
        for i in arra:
            for j in arra:
                ...
                if coordinates_centre is not None:
                    vi_centre, vj_centre= coordinates_centre
                    obs = self.gen_obs()
...
#        for the ICLR paper (reward included)
        if self.trigger_switch==True:
